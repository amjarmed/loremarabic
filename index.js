/**
 * @name: `Lorem Ipsum Arabic`
 *@desc: a tool to generate arabic lorem Ipsum text.
 *@author : amjarmed
 *@website : https://www.amjarmed.com/
 */

/*
 * @Data: ARABIC AND ENGLISH LOREM IPSUM DATA
 */
const loremData = {
  arAlphabets: [
    'ا',
...
/* 
 ...
 LOREM OBJECT RETURN METHODS AND Random DATA 
*/
const ArabicLorem = () => ({
  alphabets: loremData.arAlphabets,
  ...
  naturalArabic: loremData.arabicWords,
});
